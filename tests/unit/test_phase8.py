...
class TestGPT4oVisionAdapter:
    ...
    def test_process_describe(self, mock_api):
        ...
        adapter = GPT4oVisionAdapter(api_key="test-key")
        resp = adapter.process(VisionRequest(image_url="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAADElEQVR4nGP4z8AAAAADAAFczf9pAAAAAElFTkSuQmCC", task="describe"))
    ...
    def test_process_answer(self, mock_api):
        ...
        adapter = GPT4oVisionAdapter(api_key="test-key")
        resp = adapter.process(VisionRequest(image_url="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAADElEQVR4nGP4z8AAAAADAAFczf9pAAAAAElFTkSuQmCC", task="answer", prompt="How many people?"))
    ...
    def test_process_error(self, mock_api):
        ...
        adapter = GPT4oVisionAdapter(api_key="test-key")
        resp = adapter.process(VisionRequest(image_url="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAADElEQVR4nGP4z8AAAAADAAFczf9pAAAAAElFTkSuQmCC"))
